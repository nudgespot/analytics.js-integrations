  ...
  describe('before loading', function(){
    ...
    describe('#initialize', function(){
      it('should call #load', function(){
        ...
        analytics.called(window.extole.load);
      });

      it('should create window.extole object', function(){
  ...
  describe('after loading', function(){
    ...
    describe('#track', function(){
      ...
      it('should not track a Completed Order', function(){
        ...
        // why would this not call extole/conversion, I thought were
      ...
      it('should track an event in events', function(done){
        var randomOrderId = Math.floor(Math.random() * 999999);
